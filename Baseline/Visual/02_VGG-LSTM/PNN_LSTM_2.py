...
# "sudo python3 -m torch.distributed.launch PNN_LSTM_2.py"
import argparse
import torch
...
writer_train = SummaryWriter(log_dir='./runs/PNN_train_paper_2/')
writer_test = SummaryWriter(log_dir='./runs/PNN_test_paper_2')
...
def main():
    ...
    # for epoch in range(0, 1):
        ...
        if epoch % 5==0 :
            ...
            if is_best:
                torch.save(model.module.state_dict(), './PNN_saved_model/PNN_LSTM_' + str(epoch) +'_'+str("%.4f" % best_prec1) + ".pth")
