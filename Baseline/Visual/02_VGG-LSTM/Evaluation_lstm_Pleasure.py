...
1。 lossMIN调整
2。 tensorboard一起优化
sudo python3  -m torch.distributed.launch Evaluation_lstm_Pleasure.py
...
def main():
    ...
    # Load Data
    test_dataset = Pleasure_FileDatabase.FlameSet()
    ...
    model_CKPT = torch.load('/home/dell/Xinda/werewolf_video/saved_model_Pleasure/lstm_loss_332.1387.pth.tar')
    model_state = model_CKPT['state_dict']
    ...
    with torch.no_grad():
        ...
        df.to_csv("eval_pleasure.csv")
        print("eval_pleasure.csv save success!!")
