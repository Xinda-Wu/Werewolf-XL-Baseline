...
def main():
    ...
    model_CKPT = torch.load('/home/dell/Xinda/werewolf_video/PNN_saved_model/PNN_LSTM_60.pth')
    ...
    with torch.no_grad():
        ...
        for i, videoFrames in enumerate(tqdm(test_loader)):
            ...
            # print("outputs_average = ",outputs_average.data)
            ...
            # if torch.isnan(outputs_average):
            #     continue
            # else:
            #     groundTruth.append(label.item())
            #     _, predicted = torch.max(outputs_average.data, 1)
        ...
        df2.to_csv("categorical04_lstm_6pnn_20200611.csv")
