...
class FlameSet_Train(data.Dataset):
    def __init__(self,cv):
        # 所有图片的绝对路径
        csvPath = f'/mnt/nfs-shared/xinda/Werewolf-XL/Werewolf-XL_202106/2_LSTM/LSTM/Split_dataset/CV_Features/RegressionFeatures/Train_CV_{cv}.csv'
