...
import Dominance_TestFileDataset
...
def main():
    ...
    # Load Data
    test_dataset = Dominance_TestFileDataset.FlameSet()
    ...
    torch.distributed.init_process_group(backend="nccl", init_method='tcp://localhost:23463', rank=0, world_size=1)
    model_path = './checkpoints/Dominance_lstm_loss_261.0136.pth'
    ...
    with torch.no_grad():
        ...
        df.to_csv("./prediction_result/eval_dominance.csv")
