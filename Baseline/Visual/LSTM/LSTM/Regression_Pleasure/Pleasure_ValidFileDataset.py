...
#定义自己的数据集合
class FlameSet_Valid(data.Dataset):
    def __init__(self, cv):
        # 所有图片的绝对路径
        csvPath = f'/mnt/nfs-shared/xinda/Werewolf-XL/Werewolf-XL_202106/2_LSTM/LSTM/Split_dataset/CV_Features/RegressionFeatures/Validation_CV_{cv}.csv'
        df = pd.read_csv(csvPath)
        pre_fillename = df['VideoName'].values
        # Pleasure_average,Arousal_average,Dominance_average
        labels = df['Mean_P_1_2_3_4'].values
